class DropBoxController {
    ...
    constructor(){
        ...
        this.onselectionchange = new Event('selection-change');
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyBosdCd3bDQseWvXwdzxJVbvOhhI6Z7RVg",
    authDomain: "dropbox-clone-415b4.firebaseapp.com",
    databaseURL: "https://dropbox-clone-415b4.firebaseio.com",
    projectId: "dropbox-clone-415b4",
    storageBucket: "dropbox-clone-415b4.appspot.com",
    messagingSenderId: "651656889764",
    appId: "1:651656889764:web:d8358d0eacb42a80beed31",
    measurementId: "G-3B15JNSF10"
  };
  // Initialize Firebase
  ...
  firebase.analytics();
    ...
    initEvents(){
        ...
        this.listFilesEl.addEventListener('selection-change', e=>{
